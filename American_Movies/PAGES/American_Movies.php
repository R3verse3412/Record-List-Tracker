...
<div class="mb-5 container">
    ...
    <table id="American_Movies" class="table table-bordered table-striped">
        <thead>
            <tr>
                <th>Image</th>
                <th>Name</th>
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>
                            ...
                            <td>
                                ...
                                <button class='btn btn-warning' data-bs-toggle='modal' data-bs-target='#movieModal' data-id='{$row['id']}' data-name='{$row['name']}' data-summary='{$row['summary']}' data-genre='{$row['genre']}' data-rating='{$row['rating']}' data-year='{$row['year']}' data-img='{$row['img']}' data-cast='" . htmlspecialchars($row['cast']) . "' data-director='{$row['director']}'>Show</button>
                            </td>
                          </tr>";
                }
            }
