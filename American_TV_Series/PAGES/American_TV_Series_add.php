<?php include "../PHP/American_TV_Series_add.php" ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>PHP CRUD - Add New American TV Series</title>
    <?php
    include "../../header.php"
    ?>
</head>
...
?>
    ...
    <div class="container">
        <div class="text-center mb-4">
            <h3>Add New American TV Series</h3>
            <p class="text-muted">Complete the form below to add a new American TV Series</p>
        </div>
