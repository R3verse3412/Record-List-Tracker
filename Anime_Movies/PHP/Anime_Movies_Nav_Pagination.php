...
<nav aria-label="Pagination">
    <ul class="pagination">
        ...
        <li class="page-item <?php if ($current_page == 1) echo 'disabled'; ?>">
            <a class="page-link" href="Anime_Movies.php?page=<?php echo max(1, $current_page - 1) . $query_string; ?>">Previous</a>
        </li>
        ...
        if ($start_page > 1) {
            echo '<li class="page-item"><a class="page-link" href="Anime_Movies.php?page=1' . $query_string . '">1</a></li>';
            if ($start_page > 2) {
        ...
        for ($i = $start_page; $i <= $end_page; $i++) {
            echo '<li class="page-item ' . ($i == $current_page ? 'active' : '') . '">
                    <a class="page-link" href="Anime_Movies.php?page=' . $i . $query_string . '">' . $i . '</a>
                  </li>';
        }
        ...
        if ($end_page < $total_pages) {
            ...
            echo '<li class="page-item"><a class="page-link" href="Anime_Movies.php?page=' . $total_pages . $query_string . '">' . $total_pages . '</a></li>';
        }
        ?>

        <!-- Next Button -->
        <li class="page-item <?php if ($current_page == $total_pages) echo 'disabled'; ?>">
            <a class="page-link" href="Anime_Movies.php?page=<?php echo min($total_pages, $current_page + 1) . $query_string; ?>">Next</a>
        </li>
    </ul>
</nav>
