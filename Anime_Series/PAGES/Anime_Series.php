<?php include "../PHP/Anime_Series.php";
include "../PHP/Anime_Series_Pagination.php";
include "../PHP/Anime_Series_Search.php";
?>
...
<head>
    ...
    <link href="../CSS/Anime_Series.css" rel="stylesheet">
</head>
<body>
...
<section class="section">
    ...
    <div class="mb-4">
        ...
        <form method="GET" action="Anime_Series.php" class="d-flex mb-4">
            ...
            <div class="row d-flex justify-content-between mb-4">
                <div class="d-flex justify-content-center">
                    <?php
                    include "../PHP/Anime_Series_Nav_Pagination.php";
            ...
            <div class="container mb-5" id="movies-container">
             <?php include "../PHP/Anime_Series_Card.php";?>
            </div>

            <!-- Pagination -->
            <div class="d-flex justify-content-center">
                <?php include "../PHP/Anime_Series_Nav_Pagination.php"; ?>
            </div>
        </div>
</section>
