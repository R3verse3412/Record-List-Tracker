...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($_FILES['img']['error'] === UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($img_tmp_name, $img_path)) {
            ...
            $sql = "INSERT INTO cartoon_movies (user_id, name, summary, year, genre, rating, director, img, date_added) VALUES (?, ?, ?, ?, ?, ?, ?, ?, NOW())";
...
<head>
    ...
    <title>PHP CRUD - Add New Cartoon Movies</title>
    <?php
    include "../../header.php"
    ?>
</head>
...
?>
    ...
    <div class="container">
        <div class="text-center mb-4">
            <h3>Add New Cartoon Movie</h3>
            <p class="text-muted">Complete the form below to add a new Cartoon Movies</p>
        </div>
