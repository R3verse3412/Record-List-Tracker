<?php include "../PHP/Cartoon_Series_edit.php"; ?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="container">
        <div class="text-center mb-4">
            <h3>Edit Cartoon Series</h3>
            <p class="text-muted">Update the details of the cartoon series</p>
        </div>
            ...
            <form action="" method="post" enctype="multipart/form-data" style="width: 50vw; min-width: 300px;">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" name="episodes"
                        value="<?php echo htmlspecialchars($episodes); ?>" min="1" max="2000">
                </div>
                <div class="mb-3">
